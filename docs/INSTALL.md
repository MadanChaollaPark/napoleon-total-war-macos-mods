...
This installs faction unlocks, all core faction-parity database packs, and the
checksummed WW0 Europe startpos delta. It does not download or enable Radious.
